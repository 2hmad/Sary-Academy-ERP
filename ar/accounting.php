...
if(isset($_GET['month']) && $totalItems > 0) {
    ...
    <form method="POST" style="width:auto" action="export_accounting.php?month='.$month_get.'">
        <button class="btn btn-success" name="export" type="submit" style="width: auto;margin-bottom:2%;text-transform:capitalize;float:left"><i class="far fa-file-csv"></i> تحميل شهر '.$month_get.'</button>
    </form>
    ';
}
?>
