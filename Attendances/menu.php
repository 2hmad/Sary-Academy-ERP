<div class="menu-dashboard">
    <div class="menu-container">
        ...
        <div class="menu-links">
            ...
            <div class="group">
            <span>Academic</span>
            <a href="display-sessions.php?month=<?php echo date('M') ?>" style="display:none"><button class="menu-link sessions-menu"><i class="fas fa-plug" style="margin-right: 5%;"></i> Play Area</button></a>
            ...
            <?php
                if($per_three !==""){
                    echo '<a href="add-hours.php" style="display:none"><button class="menu-link add-hours-menu"><i class="fas fa-id-card" style="margin-right: 5%;"></i> Add Hours</button></a>';
                }
            ?>
